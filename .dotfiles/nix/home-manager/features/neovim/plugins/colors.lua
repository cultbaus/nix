...
local function overrides_colors()
    vim.cmd [[
...
local highlights = [[
    hi StatusLineAccent guifg=#1d2021 guibg=#89b482
    hi StatusLineInsertAccent guifg=#1d2021 guibg=#ea6962
    hi StatusLineVisualAccent guifg=#1d2021 guibg=#a9b665
    hi StatusLineReplaceAccent guifg=#1d2021 guibg=#ea6962
    hi StatusLineCmdLineAccent guifg=#1d2021 guibg=#d8a657
    hi StatuslineTerminalAccent guifg=#1d2021 guibg=#d8a657
    hi StatusLineExtra guifg=#a89984
...
local function setup_colors()
    ...
    local ok, _ = pcall(cmd, 'colorscheme gruvbox-material')
    if not ok then
        return
    end
